...
class SignUpForm(UserCreationForm):
    ...
    first_name = forms.CharField(label='', max_length=255, widget=forms.TextInput(attrs={'class': 'form-control',
                                                                                         'placeholder': 'First Name'}))
    last_name = forms.CharField(label='', max_length=255, widget=forms.TextInput(attrs={'class': 'form-control',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].help_text = '<span class="form-text text-muted small">Required.150 characters or' \
                                            ' fewer. Letters, digits and @/./+/-/_ only.</span>'
        ...
        self.fields['password1'].help_text = '<ul class="form-text text-muted small"><li>Your password can\'t be too ' \
                                             ...
                                             'commonly used password.</li><li>Your password can\'t be ' \
